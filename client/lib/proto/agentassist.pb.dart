...
class McpTaskFinishRequest extends $pb.GeneratedMessage {
  ...
  McpTaskFinishRequest._() : super();
  factory McpTaskFinishRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory McpTaskFinishRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
...
class TaskFinishRequest extends $pb.GeneratedMessage {
  ...
  TaskFinishRequest._() : super();
  factory TaskFinishRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TaskFinishRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  ...
  @$pb.TagNumber(3)
  set request(McpTaskFinishRequest v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasRequest() => $_has(2);
  @$pb.TagNumber(3)
  void clearRequest() => clearField(3);
...
class TaskFinishResponse extends $pb.GeneratedMessage {
  ...
  TaskFinishResponse._() : super();
  factory TaskFinishResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TaskFinishResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
...
class PendingMessage extends $pb.GeneratedMessage {
  factory PendingMessage({
    ...
    if (taskFinishRequest != null) {
      $result.taskFinishRequest = taskFinishRequest;
    }
    if (createdAt != null) {
  ...
  @$pb.TagNumber(3)
  set taskFinishRequest(TaskFinishRequest v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasTaskFinishRequest() => $_has(2);
  @$pb.TagNumber(3)
  void clearTaskFinishRequest() => clearField(3);
  @$pb.TagNumber(3)
...
class WebsocketMessage extends $pb.GeneratedMessage {
  factory WebsocketMessage({
    ...
    if (taskFinishResponse != null) {
      $result.taskFinishResponse = taskFinishResponse;
    }
    if (strParam != null) {
  ...
  @$pb.TagNumber(5)
  set taskFinishResponse(TaskFinishResponse v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasTaskFinishResponse() => $_has(4);
  @$pb.TagNumber(5)
  void clearTaskFinishResponse() => clearField(5);
  @$pb.TagNumber(5)
